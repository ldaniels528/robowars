...
import org.combat.game.actors.AntiTankCannon;
import org.combat.game.actors.FesseTank;
import org.combat.game.actors.Glider;
import org.combat.game.ai.AttackAI;
import org.combat.game.ai.MotionAI;
import org.combat.game.structures.GenericBuilding;
import org.combat.game.structures.GenericPillar;
import org.combat.game.structures.GenericWall;
import org.combat.game.structures.MainGate;
...
public class VirtualWorldImpl extends VirtualWorld {
	private final AbstractPlayer activePlayer;
	...
	public void populateWorld(final AbstractPlayer activePlayer) {
		// -- the front wall
		...
		ab.selectTarget(activePlayer); ab.attackTarget();
